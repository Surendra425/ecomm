        ...
        <div class="col-sm-6" id="login-page" >
            ...
            <form name="myform" method="post" action="{{ url('change-password')}}" id="password_change">
                ...
                <div class="form-group">
                    ...
                    <input id="password_confirmation" name="password_confirmation" class="form-control clsLoginField" type="password" data-validation="required" placeholder="Last Name">
                </div>
                <div class="form-group">
