                    ...
                    <td class="item-col item">
                      <table cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                          ...
                          <td class="product">
                            <span>{{ $product->product_title }} {{ !empty($product->combination_title) ? ' ('.$product->combination_title.') ' : '' }}
...
@endif
                  ...
                  <tr>
                    ...
                    <td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
                      <span class="total-space">{{ ($order->shipping_total == 0) ? 'FREE' : (float)($order->shipping_total).' KD' }} </span>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
                      <span class="total-space">{{ (float)($order->grand_total) }} KD</span>
                    </td>
                  </tr>
                </table>
              </td>
