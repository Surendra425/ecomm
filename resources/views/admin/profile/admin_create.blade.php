...
@section('content')
    @php
        $pageTitle ="adminAdd";
    $contentTitle =empty($admins) ? 'Create Admin' : 'Edit Admin';
    @endphp
    ...
    <!--begin::Portlet-->
        <div class="m-portlet m-portlet--tab">
                ...
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        ...
                        <h3 class="m-portlet__head-text">
                            {{(empty($admins)) ? 'Create Admin' : 'Edit Admin'}}
                        </h3>
                    </div>
                </div>
            </div>
            ...
            <form id="admin_create" class="m-form m-form--fit m-form--label-align-right form"
                  ...
                  action="<?php echo (!empty($admins)) ? (url(route('AdminUpdate', ['admin' => $admins['id']]))) : (url(route('AdminStore'))); ?>"
                  novalidate>
                {{ csrf_field() }}
                <input type="hidden" name="id" id="id" value="<?php if(!empty($admins)){ echo $admins->id; } ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group m-form__group" >
                                        <input type="hidden"name="profile_image_1" id="profile_image_1" value="<?php if(!empty($admins->profile_image)) { echo $admins->profile_image;} ?>">
                                            <img id="blah" src="{{ !empty($admins->profile_image) ? url('/doc/profile_image').'/'.$admins->profile_image : url('assets/app/media/img/no-images.jpeg')}}" width="50" height="50">
                                    </div>
                                </div>
                            </div>
                        </div>
