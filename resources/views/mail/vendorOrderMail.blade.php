                    ...
                    <td class="item-col item">
                      <table cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                          ...
                          <td class="product">
                            <span>
                              {{ $product->product_title }} {{ !empty($product->combination_title) ? ' ('.$product->combination_title.') ' : '' }}
...
@endif
                  ...
                  <tr>
                    ...
                    <td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
                      <span class="total-space">{{ (float)($order->sub_total) }} KD</span>
                    </td>
                  </tr>
                  <tr>
                    <td class="item-col item">
                    ...
                    <td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
                      <span class="total-space">{{ !empty($order_products[0]) ? ($order_products[0]->shipping_charges == 0) ? 'FREE' : ((float)($order_products[0]->shipping_charges).' KD') : 0 }} </span>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
                      <span class="total-space">{{!empty($order_products[0]) ? (float)($order->sub_total + $order_products[0]->shipping_charges) : (float)($order->sub_total) }} KD</span>
                    </td>
                  </tr>
                </table>
              </td>
