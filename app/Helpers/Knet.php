...
class Knet
 {
    ...
    function __construct() {
        $this->webAddress = "https://shopzz.com/";
        $this->port = "";
        $this->id = "";
        $this->password = "";
    ...
    function performPaymentInitialization() {
        ...
        if (strlen($this->orderId) > 0)
            $stringbuffer.=("orderId=" . $this->orderId . "&");
    ...
    /**
     * AES Encryption sub Method Starts
     * @param $text
     * @return string
     */
