...
<head>
  ...
  <title>I Can Save the world Email Template</title>
...
<table align="center" cellpadding="0" cellspacing="0" class=" container-for-gmail-android" width="100%">
                ...
                <table cellpadding="0" cellspacing="0" width="600" class="w320">
                  <tr>
                    <td class="pull-left mobile-header-padding-left" style="vertical-align: middle; text-align: center;">
                      <a href=""><img width="150" src="{{ url('assets/logo_top.png') }}" alt="logo" title="logo"></a>
                    </td>
                  </tr>
                </table>
              </center>
                ...
                <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                    ...
                    <tr>
                        ...
                        <td class="mini-block" width="50%">
                            ...
                            Email : {{ $order->user->email or '-'}}  <br />
                            Mobile : {{ $order->user->mobile_no or '-'}}  <br />
                        </td>
                    </tr>
                </table>
            </td>
 ...
 {{--Customer detail    --}}
                                          ...
                                          {{--<tr>--}}
                                              {{--<td class="mini-block-padding">--}}
                                                  {{--<table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">--}}
                                                      {{--<tr>--}}
                                                          {{--<td class="mini-block">--}}
                                                              {{--<span class="header-sm">Customer Details</span><br />--}}
                                                              {{--Name : {{ $order->customer_name }} <br />--}}
                                                              {{--Email : {{ $order->user->email or '-'}}  <br />--}}
                                                              {{--Mobile : {{ $order->user->mobile_no or '-'}}  <br />--}}
                                                          {{--</td>--}}
  ...
  {{--</tr>--}}
    ...
    @if(isset($vendorStores) && !empty($vendorStores))
            ...
            <tr>
              <td class="item-table">
                <table cellspacing="0" cellpadding="0" width="100%">
                  ...
                  <tr>
                      {{--<td>--}}
                          {{--<span class="table-store-header" style="text-align: left;width: 220px;color: #404040;">Vendor Name : {{ $store['vendor_name'] }}</span>--}}
                      {{--</td>--}}
                      <td style="    text-align: left;">
                          <span class="table-store-header" style="text-align: left !important;float:left; width: 100px;color: #404040;"> Store : {{ $store['stores'] }} </span>
                      </td>
                  </tr>
                  <tr class="title_bg" style="width: 100%">
                    <td class="title-dark product_title" width="200px">
                       Product
                    </td>
                    <td class="title-dark qty_title" width="150px" style="text-align: center;">
                      Qty
                    </td>
               ...
               @foreach($store['products'] as $k => $product)
                  @php $subTotals+= $product['sub_total']; @endphp
                  <tr>
                      ...
                      <table cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                          ...
                          <td class="product">
                            ...
                            <span>
                              {{ $product['product_title'] }} {{ !empty($product['option']['combination_title']) ? ' ('.$product['option']['combination_title'].') ' : '' }}
                              @if(!empty($product->note))
                              <br><b>Note: </b> {{ $product->note }}
                             @endif
                            </span> <br />
                          </td>
                        </tr>
               ...
               @endforeach
                  ...
                  <tr>
                    ...
                    <td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
                      <span class="total-space">{{ (float)($subTotals) }} KD</span>
                    </td>
                  </tr>
                    ...
                    <table width="100%" style="">
                        <tr>
                            ...
                            <td class="item-col price" style="text-align: left;">
                                <span class="total-space">{{ !empty($order->sub_total) ? (float)($order->sub_total) .' KD' : 'FREE' }} </span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
                                <span class="total-space">{{ !empty($order->shipping_total) ? (float)($order->shipping_total) .' KD' : 'FREE' }} </span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
                                <span class="total-space">{{ (float)($order->discount_amount) }} KD</span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
                                <span class="total-space">{{!empty($order->grand_total) ? (float)($order->grand_total) : (float)($order->grand_total) }} KD</span>
                            </td>
                        </tr>
                          ...
                          <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                            <tr>
                              <td class="mini-block">
                                ...
                                {{ !empty($shipping_address->block) ? $shipping_address->block ."," : '' }}
                                {{ !empty($shipping_address->street) ? $shipping_address->street ."," : '' }}
                                {{ !empty($shipping_address->avenue) ? $shipping_address->avenue ."," : ''}}
                                {{ !empty($shipping_address->building) ? $shipping_address->building : ''  }} <br />
                                {{ !empty($shipping_address->floor) ? $shipping_address->floor ."," : '' }}
                                {{ !empty($shipping_address->apartment) ? $shipping_address->apartment : '' }}
                                {{ $shipping_address->mobile_no or '-'}} <span>(mobile)</span> <br />
                                {{ $shipping_address->landline_no or '-'}} <span>(landline)</span>  <br />
                                {{ !empty($shipping_address->country) ? $shipping_address->country."," : ''}}
                                {{ !empty($shipping_address->city) ? $shipping_address->city : '' }}  <br />
                              </td>
                            </tr>
                          </table>
                        </td>
                            ...
                            <tr>
                              <td class="mini-block">
                                ...
                                @elseif($order->payment_type == 'CreditCard')
                                      ...
                                      Credit Card Transaction Id : {{ !empty($order->credit_card_transaction_id) ? $order->credit_card_transaction_id : '' }}<br>
                                      Credit Card Transaction Receipt : {{ !empty($order->credit_card_transaction_receipt) ? $order->credit_card_transaction_receipt : '' }}<br>
                                @elseif($order->payment_type == 'KNet')
                                      Payment Type : KNet <br>
                                      Payment Status : {{$order->payment_status}} <br>
                                      KNet Payment Id  : {{ !empty($order->knet_payment_id) ? $order->knet_payment_id : '' }} <br>
                                      KNet Transaction Id  : {{ !empty($order->knet_tran_id) ? $order->knet_tran_id : '' }} <br>
                                @endif
