...
<head>
    <meta charset="utf-8" />
    <title>I Can Save the world | Vendor Login</title>
            ...
            <div class="m-login__container">
                ...
                <div class="m-login__signin">
                    <div class="m-login__head">
                        <h3 class="m-login__title">Sign In To Vendor Area</h3>
                    </div>
                    <div class="container">
                        <div class="row">
                             <div class="col-md-12">
                   ...
                   @if ($errors->has('email'))
                    ...
                    @endif
                    <form class="m-login__form m-form" action="{{ url('/vendor') }}" method="POST" id="formLogin">
                        {{ csrf_field() }}
                        ...
                        <div class="row m-login__form-sub">
                            ...
                            <div class="col m--align-right">
                                <a href="{{ url('vendor/password/reset') }}" id="m_login_forget_password" class="m-link">Forget Password ?</a>
                            </div>
                        </div>
                    ...
                    <div class="m-login__account">
                        ...
                        <a href="{{ route('sellWithUs') }}" id="m_login_signup" class="m-link m-link--focus m-login__account-link">Request For Vendor Account</a>
                    </div>
                </div>
            </div>
        </div>
