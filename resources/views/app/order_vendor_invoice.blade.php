...
/*       padding: 20px 0 5px; */
    ...
    .free-text {
      color: #000000; text-align: left; font-size: 20px;
    }
    .product span {
    ...
    <td align="center" valign="top" width="100%" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          ...
          <tr>
            <td class="free-text">
              <strong>Store Name: </strong> {{ $vendor['store']->store_name or ''}}
            </td>
          </tr>
          <tr>
            <td class="free-text">
              ...
              <td class="item-table">
                <table cellspacing="0" cellpadding="0" width="100%">
                  <tr class="title_bg">
                    ...
                    <td class="title-dark qty_title" width="200px" style="text-align: left;">
                      Qty
                    </td>
...
@if(isset($vendorOrderProducts) && !empty($vendorOrderProducts))
@php 
$total = 0;
@endphp

@foreach($vendorOrderProducts as $orderProduct)
                  @php
                      $total += $orderProduct->sub_total;
                      $shipping_charges = $orderProduct->shipping_charges;
                  @endphp
                  <tr>
                    <td class="item-col item">
                      <table cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                          ...
                          <td class="product">
                            <span>
                              {{ $orderProduct->product->product_title }} {{ !empty($orderProduct->option->combination_title) ? ' ('.$orderProduct->option->combination_title.') ' : '' }}
                              @if(!empty($orderProduct->note))
                              <br><b>Note: </b> {{ $orderProduct->note }}
                             @endif
                            </span> <br />
                          </td>
                        </tr>
                    ...
                    <td class="item-col price">
                      {{ (float)($orderProduct->sub_total) }} KD
                    </td>
                  </tr>
@endforeach
@endif
                  ...
                  <!--<tr>
                    ...
                    <td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
                      <span class="total-space">{{ (float)($order->subTotal) }} KD</span>
                    </td>
                  </tr>
                   <tr>
                    <td class="item-col item">
                    ...
                    <td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
                      <span class="total-space">{{ !empty($vendorOrderProducts) ? (float)($shipping_charges) : 0 }} KD</span>
                    </td>
                  </tr> -->
                  <tr>
                    <td class="item-col item">
                    ...
                    <td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
                      <span class="total-space">{{ $total }} KD</span>
                    </td>
                  </tr>
                 ...
                 <tr>
                  ...
                  <td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
                      <span class="total-space">{{ (float)$shipping_charges }} KD</span>
                  </td>
                 </tr>
                 ...
                 <tr>
                  ...
                  <td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
                      <span class="total-space">{{ (float)($shipping_charges + $total) }} KD</span>
                  </td>
                  </tr>
                </table>
              </td>
                          ...
                          <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                            <tr>
                              <td class="mini-block">
                                ...
                                {{ !empty($address->block)?$address->block .",":'' }} {{ !empty($address->street)?$address->street .",":'' }} {{ !empty($address->avenue)?$address->avenue .",":'' }} {{  !empty($address->building)?$address->building:'' }} <br />
                                {{ !empty($address->floor)?$address->floor .",":'' }} {{ !empty($address->apartment)?$address->apartment:'' }}  <br />
                                {{ $address->mobile_no }} <span>(mobile)</span>  <br />
                                {{ $address->landline_no }} @if(!empty($address->landline_no)) <span>(landline)</span> @endif <br />
                              </td>
                            </tr>
                          </table>
                        </td>
