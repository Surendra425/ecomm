...
@section('title') Deals List @endsection
@section('css')
    ...
    <div class="m-portlet__head">
        <div class="m-portlet__head-caption">
            <div class="row">
                ...
                <div class="col-md-6">
                    <a href="{{ url(route('deals.create')) }}" class="btn btn-outline-primary m-btn m-btn--custom m-btn--icon m-btn--pill m-btn--air pull-right">
                        <span>
