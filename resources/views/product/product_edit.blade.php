                ...
                <fieldset class="m-portlet__body" id="attr_list">
                    ...
                    <div class="m-form__group form-group">
                        ...
                        <div class="m-radio-inline">
                            ...
                            <label class="m-radio">
                                <input type="hidden" name="old_combination" id="old_combination" value="{{(isset($product->options) && !empty($product->options)  && count($product->options) >= 1 && isset($product->options[0])  &&  $product->options[0]->combination_title != '') ? 'Yes' : 'No'}}">
                                <input type="radio" name="combination" id="combinationYes" value="Yes" {{(isset($product->options) && !empty($product->options)  && count($product->options) >= 1 && isset($product->options[0]) && $product->options[0]->combination_title != '') ? 'checked' : ''}}> Yes
                                <span></span>
                            </label>
                    ...
                    @if((isset($product->options) && !empty($product->options) && count($product->options) >= 1) && isset($product->options[0])  && $product->options[0]->combination_title != '')
                        @php
                            $class='';
                        @endphp
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group m-form__group">
                                    ...
                                    <input type="hidden" name="option_id" id="option_id" value="{{$product->options[0]->id ?? 0}}">
