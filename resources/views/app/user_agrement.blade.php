@extends('layouts.app')
@section('title') User Agreement @endsection
@section('content')
    ...
    <div class="container-fluid">
        <div class="container help">
            <div>
                <h4>{{$userAgrement->headline or 'User Agreement'}}</h4><br>
                <?php echo !empty($userAgrement->description) ? $userAgrement->description : 'No content' ?>
            </div>
        </div>
    </div>
